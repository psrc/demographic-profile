...
# In King: Spanish, Chinese, Vietnamese, Hindi
...
# Regionally, the ten most common languages spoken at home, other than English, are Spanish (23.6%), Chinese (8.7%), Vietnamese (5.4%), Korean (5.0%), Hindi (4.9%), Russian (4.0%), Tagalog (3.5%), Mandarin (3.5%), Japanese (2.5%), and Telugu (2.1%). 
...
# In Kitsap County, the top 5 are: Spanish, Tagalog, Japanese (fair), Filipino (fair), and Vietnamese (weak)
